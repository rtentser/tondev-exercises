...
abstract contract ExtendedShoppingDebot is BaseShoppingDebot {
    ...
    function addPurchase__(string value) public {
        ...
        if (success) {
            ...
            Terminal.print(tvm.functionId(menu), "It's not a valid quantity!");
        }
    }
    ...
    function removePurchase_(string value) public {
        ...
        if (success) {
            ...
            Terminal.print(tvm.functionId(menu), "It's not a valid id!");
        }
    }
    ...
    function buy__(string value) public {
        ...
        if (success) {
            ...
            Terminal.print(tvm.functionId(menu), "It's not a valid price!");
        }
    }
}